...
// // 用途として、・特定のスロットを全て読む　以外のものは出さないでいいんじゃねーかなーと思うなど。ステップ実行とかステップバックとかができると
// // 素晴らしいと思うが、インターフェース的にどう書ける？
// // back　でいいのか。
// // その時どんなそうさが出来るのが良い？
// // 特定のスロットに対して、今のスロット内インデックスから一個もどった所までをすべて再生する。
// // ・リセット -> -1まで再生
// // ・リセット -> -2まで再生
// // これって、backとかのアクションをセットしておけばできることだけど、プレイ開始とかで区切らなければ、最後のコンパイル→実行時、で地続きになる。
// // スロット別に要らないのでは？　はい。
