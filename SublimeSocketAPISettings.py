...
SELECTEDREGIONS_INJECTIONKEYS 	= [SELECTEDREGIONS_VIEW, SELECTEDREGIONS_PATH, SELECTEDREGIONS_TARGET, SELECTEDREGIONS_LINE, SELECTEDREGIONS_FROM, SELECTEDREGIONS_TO, SELECTEDREGIONS_MESSAGES]
...
SHOWTOOLTIP_SELECTEDITEM	= "selected"
