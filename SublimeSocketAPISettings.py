...
COUNTUP_RESULT				= "result"
COUNTUP_INJECTIONS			= [COUNTUP_RESULT]
...
OPENFILE_PATH				= "path"
OPENFILE_INJECTIONS			= [OPENFILE_PATH]

API_CLOSEFILE				= "closeFile"
CLOSEFILE_NAME				= "name"
CLOSEFILE_INJECTIONS		= [CLOSEFILE_NAME]

API_CLOSEALLBUFFER			= "closeAllBuffer"
CLOSEALLBUFFER_CLOSED		= "closed"
CLOSEALLBUFFER_INJECTIONS	= [CLOSEALLBUFFER_CLOSED]
...
REACTOR_VIEWKEY_INJECTIONS = [REACTOR_VIEWKEY_EMITIDENTITY, REACTOR_VIEWKEY_VIEWSELF, REACTOR_VIEWKEY_SELECTEDS, REACTOR_VIEWKEY_PATH, REACTOR_VIEWKEY_ISEXIST]
...
VIEWEMIT_INJECTIONS 		= [VIEWEMIT_BODY, VIEWEMIT_PATH, VIEWEMIT_ROWCOL, VIEWEMIT_IDENTITY]
...
MODIFYVIEW_INJECTIONS		= [MODIFYVIEW_PATH]
...
SETSELECTION_INJECTIONS		= [SETSELECTION_PATH, SETSELECTION_SELECTEDS]
...
CLEARSELECTION_INJECTIONS	= [CLEARSELECTION_PATH,CLEARSELECTION_CLEARDS]
...
SELECTEDREGIONS_INJECTIONS 	= [SELECTEDREGIONS_VIEW, SELECTEDREGIONS_PATH, SELECTEDREGIONS_CROSSED, SELECTEDREGIONS_TARGET, SELECTEDREGIONS_LINE, SELECTEDREGIONS_FROM, SELECTEDREGIONS_TO, SELECTEDREGIONS_MESSAGES]
...
SHOWTOOLTIP_INJECTIONS	= [SHOWTOOLTIP_VIEW, SHOWTOOLTIP_PATH, SHOWTOOLTIP_SELECTEDITEM]
...
APPENDREGION_INJECTIONS		= [APPENDREGION_PATH, APPENDREGION_IDENTITY, APPENDREGION_LINE, APPENDREGION_FROM, APPENDREGION_TO, APPENDREGION_MESSAGE]
